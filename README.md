...
- [Installation](#installation)
    - [Option 1: Use dekupl-annotation with singularity](#option-3-use-dekupl-annotation-with-singularity)
    - [Option 2: Use dekupl-annotation with Docker](#option-2-use-dekupl-annotation-with-docker)
    - [Option 3: Install from the sources (not recommended)](#option-4-install-from-the-sources-not-recommended)
