...
sub BUILD {
  ...
  DEkupl::Utils::printStep(\$step,"Loading contigs DB into $tempdir : $datestring");
  ...
  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Remove contigs matching adapters : $datestring");
  ...
  if(-e $fasta_file && $debug) {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Skipping FASTA file : $datestring");
  } else {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Generating FASTA file : $datestring");
  ...
  if(-e $bam_file && $debug) {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Skipping GSNAP mapping : $datestring");
  } else {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Running GSNAP : $datestring");
  ...
  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Parsing BAM file : $datestring");
  ...
  if(-e "$index_dir/star") {
    ...
    if(-e $chimeric_file) {
      $datestring = gmtime();
      DEkupl::Utils::printStep(\$step,"Skipping STAR mapping : $datestring");
    } else {
      $datestring = gmtime();
      DEkupl::Utils::printStep(\$step,"Running STAR : $datestring");
  ...
  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Loading annotations into memory : $datestring");
  my $annotations = DEkupl::Annotations->new(verbose => $verbose);
  $annotations->loadFromGFF($gff_file,'gff3');

  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Loading annotations to the interval tree : $datestring");
  my $interval_query = DEkupl::IntervalQuery->new();
  $interval_query->loadAnnotations($annotations);

  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Annotating contigs : $datestring");
  ...
  if(defined $deg_file) {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Adding DEG informations : $datestring");
  ...
  if(defined $normalized_gene_counts_file && defined $sample_conditions_file) {
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Computing switches : $datestring");
  ...
  if(defined $repeat_fasta) {
    my $repeat_annot = DEkupl::RepeatAnnotation->new(verbose => $verbose, fasta => $repeat_fasta);
    $datestring = gmtime();
    DEkupl::Utils::printStep(\$step,"Annotate repeat sequences : $datestring");
    mkdir "$output_dir/RepeatAnnot" if !-e "$output_dir/RepeatAnnot/";
    $repeat_annot->alignRepeats($contigs_db,"$output_dir/RepeatAnnot/");
    DEkupl::RepeatAnnotation::contigsEntropy($contigs_db,"$output_dir/RepeatAnnot/");
    push @analyzers, $repeat_annot;
  }
  ...
  $datestring = gmtime();
  DEkupl::Utils::printStep(\$step,"Printing final output in $contigs_info_file : $datestring");
  # Print headers
...
Options:
  ...
  Optional Arguments:
      ...
      --repeat STR        FASTA file with repeat sequences
